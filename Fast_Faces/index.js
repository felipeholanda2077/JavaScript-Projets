...
const main = async () => {
  const endpoint = process.env["FACE_ENDPOINT"] ?? "https://fastfaces.cognitiveservices.azure.com/";
  const apikey = process.env["FACE_APIKEY"] ?? "e8934abbd0a54318b3ce160faf9aebee";
